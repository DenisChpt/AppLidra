...
<ins>**API related:**</ins>
- In the API Informations direcotry, you will find:
  - A .yml file generated by OpenAPI that describes the routes and controllers of the API.
  - A pdf file that displays the OpenAPI's swagger page, taht displays the yml infos in a more digest look :) (in case you can not see it when you launch).
